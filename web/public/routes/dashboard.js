...
export const DashboardPage = {
    ...
    async oncreate(vnode) {
        ...
        try {
            ...
            s.recentArticles = (articlesRes.data || []);
            s.recentPages = (pagesRes.data || []);
            s.dirs = (dirsRes.data || []);
    ...
    view(vnode) {
        ...
        return m('.dashboard', [
            ...
            m('.card', { style: { marginTop: '24px' } }, [
                ...
                m('.card-pad', { style: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))', gap: '10px' } }, s.dirs.length > 0
