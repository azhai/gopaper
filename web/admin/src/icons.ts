...
type IconName =
  | 'dashboard' | 'article' | 'image' | 'settings' | 'logout' | 'refresh'
  | 'plus' | 'edit' | 'trash' | 'search' | 'upload' | 'preview' | 'save'
  | 'folder' | 'file' | 'tag' | 'calendar' | 'user' | 'check' | 'alert'
...
const paths: Record<IconName, string> = {
  ...
  article: 'M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8l-6-6zM14 2v6h6M8 13h8M8 17h8M8 9h2',
  image: 'M3 3h18v18H3zM3 16l5-5 4 4 3-3 6 6M8.5 8a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0z',
  ...
  preview: 'M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8zM12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6z',
  ...
  error: 'M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0zM12 9v4M12 17h.01',
  success: 'M22 11.08V12a10 10 0 1 1-5.93-9.14M22 4L12 14.01l-3-3',
  'chevron-right': 'M9 18l6-6-6-6',
  'chevron-left': 'M15 18l-6-6 6-6',
  menu: 'M3 12h18M3 6h18M3 18h18',
  copy: 'M20 9h-9a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2-2v-9a2 2 0 0 0-2-2zM5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1',
  'image-plus': 'M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4M19 8h6M22 5v6M9 13a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0z',
